...
- **Reference data sync**: scheduled **WP Cron** jobs (daily / weekly / monthly) pull catalog data from the API into local tables; **manual sync** is available from admin (AJAX). Diagnostics show last sync timestamps per dataset.
